...
import { Pencil, Square, Circle, MousePointer2, Text, StickyNote, Pen, Type, Undo2, Redo2 } from "lucide-react"
    ...
    return (
        <div className="absolute top-[50%] -translate-y-[50%] left-2 flex flex-col gap-y-4">
            <div className="bg-white rounded-md p-1.5 flex gap-y-1 flex-col items-center shadow-md">
                ...
                <ToolButton label="Ellipses" icon={Circle} onClick={() => { }} isActive={false} />
